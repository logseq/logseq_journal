(** Stable UUID-addressed values for the logical Logseq overlay database. *)
...
module Generation : VERSIONED_TOKEN
module Projection_revision : VERSIONED_TOKEN
module Authoritative_revision : VERSIONED_TOKEN
module Logical_outbox_revision : VERSIONED_TOKEN
module Transport_outbox_revision : VERSIONED_TOKEN
module Block_state_revision : VERSIONED_TOKEN
...
module Mutation_fingerprint : VERSIONED_TOKEN
...
type delete_conflict_kind_set

val delete_conflict_kind_set
  :  delete_conflict_kind list
  -> (delete_conflict_kind_set, string) result

val delete_conflict_kinds : delete_conflict_kind_set -> delete_conflict_kind list
...
val sync_token_equal : sync_token -> sync_token -> bool
val sync_token_of_string : string -> (sync_token, string) result
val sync_token_to_string : sync_token -> string
...
val remote_won_proof
  :  reason:remote_won_reason
  -> batch_id:submission_batch_id option
  -> t_before:server_cursor option
  -> rejection_through:server_cursor option
  -> earliest_conflict_cursor:server_cursor option
  -> operation:outliner_operation
  -> digest:mutation_fingerprint
  -> (remote_won_proof, string) result

val remote_won_proof_batch_id : remote_won_proof -> submission_batch_id option
val remote_won_proof_t_before : remote_won_proof -> server_cursor option
val remote_won_proof_rejection_through : remote_won_proof -> server_cursor option
val remote_won_proof_earliest_conflict_cursor : remote_won_proof -> server_cursor option
val remote_won_proof_operation : remote_won_proof -> outliner_operation
val remote_won_proof_digest : remote_won_proof -> mutation_fingerprint
...
val sync_view_token : sync_view -> sync_token
val sync_view_checkpoint : sync_view -> server_cursor
val sync_view_submissions : sync_view -> submission_descriptor list
...
val submission_wire
  ...
  -> mutation_id:Graph.Uuid.t
  -> operation:outliner_operation
  -> protected_transaction:string
  -> (submission_wire, string) result

val submission_wire_mutation_id : submission_wire -> Graph.Uuid.t
val submission_wire_operation : submission_wire -> outliner_operation
val submission_wire_protected_transaction : submission_wire -> string
val submission_wire_byte_length : submission_wire -> int

type submission_batch

val submission_batch
  :  maximum_wires:int
  -> maximum_bytes:int
  -> batch_id:submission_batch_id
  -> t_before:server_cursor
  -> wires:submission_wire list
  -> (submission_batch, string) result

val submission_batch_id : submission_batch -> submission_batch_id
val submission_batch_t_before : submission_batch -> server_cursor
val submission_batch_wires : submission_batch -> submission_wire list
val submission_batch_total_bytes : submission_batch -> int
...
type encoded_transaction

val encoded_transaction_of_string
  :  maximum_bytes:int
  -> string
  -> (encoded_transaction, authoritative_input_error) result

val encoded_transaction_to_string : encoded_transaction -> string
val encoded_transaction_byte_length : encoded_transaction -> int

type authoritative_transaction

val authoritative_transaction
  :  cursor:server_cursor
  -> transaction:encoded_transaction
  -> authoritative_transaction

val authoritative_transaction_cursor : authoritative_transaction -> server_cursor
val authoritative_transaction_payload : authoritative_transaction -> encoded_transaction

type authoritative_batch

val authoritative_batch
  :  maximum_count:int
  -> maximum_bytes:int
  -> transactions:authoritative_transaction list
  -> through:server_cursor
  -> checksum:checksum option
  -> (authoritative_batch, authoritative_input_error) result

val authoritative_batch_transactions
  :  authoritative_batch
  -> authoritative_transaction list

val authoritative_batch_through : authoritative_batch -> server_cursor
val authoritative_batch_checksum : authoritative_batch -> checksum option
