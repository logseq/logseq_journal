...
val sync_metadata : connection -> (Sync_checkpoint.t, string) result
val initialize_sync_outbox : connection -> (unit, string) result
val sync_outbox : connection -> (string list, string) result
